...
<details>
  ...
  3. `wget https://github.com/gohugoio/hugo/releases/download/v0.115.2/hugo_extended_0.115.2_linux-amd64.deb`
  4. `sudo dpkg -i hugo_extended_0.115.2_linux-amd64.deb`
