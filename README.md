...
<details>
  ...
  3. `wget https://github.com/gohugoio/hugo/releases/download/v0.118.2/hugo_extended_0.118.2_linux-amd64.deb`
  4. `sudo dpkg -i hugo_extended_0.118.2_linux-amd64.deb`
