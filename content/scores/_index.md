+++
title = "Scores"
titleSeo = "Scores et échelles cliniques pour le médecin généraliste"
...
- ACFA: {{< modal-btn modal-chadsva >}}score CHA₂DS₂-VA{{< /modal-btn >}}
...
{{% /modal %}}
{{% modal title="Score CHA2DS2-VA selon ESC 2024" id="modal-chadsva"%}}
