...
todo = "écriture SEO, update 2027"
+++

La DONUM (dotation numérique du médecin généraliste) est le successeur du [Forfait structure]({{% relref "forfait-structure.md" %}}) depuis le 1^er^ janvier 2026. Elle est recentrée sur l'aide au financement des services et équipements numériques (logiciel Ségur ...) pour fluidifier et sécuriser les échanges autour du patient.
{.lead}

Comme pour le Forfait structure, la Donum dispose d'indicateurs socles, nécessaires pour y avoir droit, ainsi que d'indicateurs optionnels. La valeur du point reste également fixée à 7€ depuis 2016 (soit 5,8 € en 2025), avec un forfait maximal de 2940 € annuels lorsque tous les indicateurs sont à l'objectif.
...
- Utiliser un [logiciel (DPI) référencé Ségur](https://esante.gouv.fr/ens/segur-numerique-sante/solutions-candidates-referencees-segur) intégrant un logiciel d'aide à la prescription (LAP) certifié HAS
...
> **AAT =** arrêt de travail en ligne; **DCMT =** déclarations médecin traitant dématérialisées; **DPI =** dossier patient informatisé; **FSE =** télétransmission FSE; **PSE =** protocoles de soins électroniques
...
- Usage de l'appli carte vitale (≥ 1 FSE/an) et de la messagerie sécurisée (≥ 1 MSSanté/an) | 20 pts - 140 €
{.list-group}
...
- [Ameli Médecin. La nouvelle dotation numérique à compter du 1er janvier 2026. 09/01/2026](https://www.ameli.fr/medecin/exercice-liberal/vie-cabinet/aides-financieres/nouvelle-dotation-numerique-janvier-2026)
