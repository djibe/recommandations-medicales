...
annees = "2022"
sources = ["HAS", "SFE"]
tags = ["coeliaque", "dépression", "fatigue", "grossesse", "infertilité", "TSH", "vertige"]
...
- [Hypercholestérolémie]({{% relref "dyslipidemie.md" %}}) et [hypertriglycéridémie]({{% relref "hypertriglyceridemie.md" %}})
...
**NB. Le traitement ne doit pas être débuté sans dosage préalable de la TSH** {{%class%}}(30 % des traitements introduits sans TSH selon *HAS 2022*){{%/class%}}.
...
- Euthyrox® (ancienne formulation de Lévothyrox®, arrêt fin 2028)
- **L-Thyroxin Henning®**  
...
{{% /collapse %}}
{{%collapse "Prise en charge de l'hypothyroïdie" "show" %}}
