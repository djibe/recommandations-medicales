...
tags = ["adolescent", "asthme", "dépistage", "dyspnée", "grossesse", "HTA", "infertilité", "néphropathie", "prévention", "risque cardiovasculaire", "SAS", "tabac"]
english = ["Smoking cessation therapy"]
sctid = "710081004"
icd10 = ["F17", "Z71.6", "Z72.0"]
chart = true
flowchart = true
image = true
imageWEBP = true
...
Traitements non recommandés (efficacité non démontrée) mais inoffensifs si le patient y tient: activité physique, acupuncture, hypnose.
{.alert .alert-warning}
