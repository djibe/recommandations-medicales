...
image = false
imageSrc = ""
todo = "SPF, prise de poids, rechute HAS p.33+35+36"
+++
...
{{%info%}}Arrêter à 40 ans augmente l'espérance de vie de 7 ans, à 50 ans de 4 ans, à 60 ans de 3 ans{{%/info%}}
...
{{%info%}}1\) Dépister 2) Dépendance 3) Conseil d'arrêt{{%/info%}}
...
{{< modal-btn modal-fagerstrom >}}Fagerström-2{{< /modal-btn >}} ou version complète ci-dessous.
...
{{%info%}}Promouvoir les TNS pour tous afin de réduire la consommation: Débuter avec 1 cigarette = 1 mg de nicotine{{%/info%}}
...
{{< video poster="https://splf.fr/wp-content/uploads/2021/11/Webinaire-2021-11-16-v2-1300-500.png" mp4="http://docs.splf.fr/videos/Webinaires/2021/Webinaire-SPLF-2021-11-16.mp4" description="Webinaire SPLF: Tabac comment aider nos patients à arrêter de fumer" width="768" height="432" >}}

### Évaluation de la motivation à l'arrêt

Étapes par lesquelles passe le fumeur selon le modèle descriptif des changements de comportements développé par Prochaska et DiClemente:

1. Pré-intention: le sujet fumeur n'a pas encore envisagé d'arrêter de fumer  
  Conseiller d'arrêter, proposer une évaluation du niveau de dépendance, proposer une réduction avec TNS.
2. Intention: il pense à arrêter de fumer mais est encore ambivalent  
   Encourager à arrêter avec les traitements recommandés.
...
Ambivalent (stade l'intention): Explorer ambivalence et motivation (TODO: échelle analogique d'évaluation), envisager une réduction.
Ne souhaite pas arrêter (stade de pré-intention): Proposer une réduction de consommation avec TNS et soutien thérapeutique par PS.

TODO: aider à gérer la rechute

### Entretien motivationnel

approche relationnelle centrée sur le patient, dont le but est
de susciter ou renforcer la motivation au changement, pour aider le patient à changer son
comportement. Il se fonde sur l'idée qu'une personne n'arrivera à des changements que si la
motivation vient de la personne elle-même.
L'attitude du professionnel consistera donc en une exploration empathique de l'ambivalence de la
personne face au changement

N'est pas une confrontation ou une persuasion.
