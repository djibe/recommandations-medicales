...
Chapitres liés: [fibrillation atriale]({{< relref "fibrillation-atriale.md" >}}), [insuffisance cardiaque chronique]({{< relref "insuffisance-cardiaque-chronique.md" >}}), [hypertension artérielle maligne]({{< relref "hypertension-arterielle-maligne.md" >}})
...
: La mortalité aiguë et à 1 an est élevée (respectivement 4-10% et 25-30%).
...
En attendant le SAMU, étayer les tableaux cliniques possibles et renseigner pour le SAMU:
...
- Recherche de facteur de décompensation CHAMPIT: coronarien - hypertension - arythmie - mécanique (CIV, IM aiguë) - embolie pulmonaire - infection - tamponnade et anémie, phlébite
- Joindre les [directives anticipées]({{< relref "directives-anticipees.md" >}})

{{% /collapse %}}
{{%collapse "Examens complémentaires" %}}

La batterie d'examens urgents (ECG, BNP, troponine, radiographie thoracique ...) est hospitalière uniquement.
