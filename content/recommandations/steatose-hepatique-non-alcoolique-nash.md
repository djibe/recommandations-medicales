...
prefix = "les "
titleSeo = "Stéatose hépatique NASH"
description = "TODO:"
...
image = false
imageSrc = ""
todo = "Revoir stats de NASH, mermaid, remboursement fibromètre ?, liens vers NASH, quel rythme dépistage des personnes à risque ?, syndrome métabolique page 55, répéter dépistage tous les ?, Figure, Compléter pathologies liées"
+++

{{%article-summary%}}

- Sétatose hépatique et NASH: complications hépatiques du **syndrome métabolique** et marqueur de haut risque cardiovasculaire
- Très fort lien avec l'âge +50 ans et le diabète de type 2 (et le prédiabète)
...
: La définition de la stéatose hépatique est histologique: accumulation d'acides gras (vacuoles de triglycérides) dans le cytoplasme des hépatocytes.
...
: La stéatose métabolique est fréquente avec 20% des français atteints et expose à une surmortalité par [maladies cardiovasculaires](/specialites/cardiologie/) (x 1,5-6 d'événements) et hépatiques et [cancers](/tags/cancer/).
: La stéatose se complique également de: diabète type 2, accidents cardiovasculaires, cancers et [maladie rénale chronique]({{< relref "insuffisance-renale-chronique.md" >}}).
...
: Stéatose avec inflammation lobulaire avec une consommation d'[alcool]({{< relref "sevrage-alcool.md" >}}) inférieure 20 g/j femme et 30 g/j chez l'homme.
...
Les responsables de l'inflammation hépatique sont les éléments du **syndrome métabolique**:
...
NAFLD
: {{%lang%}}Non alcoholic fatty liver disease{{%/lang%}}
...
2. Si le score dépasse la valeur seuil ({{< modal-btn modal-fib4 >}}FIB-4{{< /modal-btn >}} ≥ 1,3 ou 2 à partir de 65 ans), demander une analyse complémentaire au laboratoire: Fibromètre®, Fibrotest® ou ELF®
