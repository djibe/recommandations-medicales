...
- Femme enceinte: pas d'alternative à la pénicilline G ([CRAT](http://le-crat.fr/articleSearchSaisie.php?recherche=Extencilline))  
...
graph TB
  ...
  style chancre stroke:#4150f5, stroke-width:1px
    ttt --> surv("- Clinique<br>- VDRL J1, M1, M3 puis /6 mois")
