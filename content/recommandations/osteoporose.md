...
tags = ["chute", "dépistage", "EPS", "prévention", "vitamine d"]
...
2. Bilan de l'ostéoporose: NFS, CRP, créatinine, bilan hépatique, vitamine D, calcémie, phosphate, électrophorèse des protéines sériques
...
5. Biphosphonate: bilan bucco-dentaire, [acide alendronique 70 mg/sem](https://base-donnees-publique.medicaments.gouv.fr/medicament/69784280/extrait#tab-rcp) ou [risédronate 35 mg/sem](https://base-donnees-publique.medicaments.gouv.fr/medicament/66887599/extrait#tab-rcp) ou 75 mg 2 jours de suite 1 fois par mois
    ...
    - [Fracture du col du fémur]({{% relref "fracture-extremite-superieure-femur.md" %}}) (FESF): [zolédronate 5 mg/100 mL](https://base-donnees-publique.medicaments.gouv.fr/medicament/66175242/extrait#tab-rcp) IVL à domicile (pas avant J+15 de la fracture).
...
- Endocrinopathie ou pathologie déminéralisante  
  Hypogonadisme prolongé (dont orchidectomie, traitement prolongé par GnRH, [aménorrhée primaire ou secondaire]({{% relref "amenorrhee.md" %}})), [hyperthyroïdie]({{% relref "hyperthyroidie.md" %}}) évolutive non traitée, hypercorticisme, [hyperparathyroïdie primaire]({{% relref "hyperparathyroidie-primaire.md" %}}), ostéogenèse imparfaite.
...
window.addEventListener('load', function() {
  $('input[name="chip-traitement"]').on('click', function(){
  $('.card-osteoporose .collapse').collapse('hide');
  $(`#div-${this.id}`).collapse('show');
  });
})
</script>
...
> [!WARNING]
> En cas de douleurs persistantes de l'aine ou des cuisses chez une patiente traitée par bisphosphonate ou dénosumab: éliminer une fracture du fémur atypique.
...
- [Souberbielle J-C et al. La supplémentation en vitamine D en France chez les patients ostéoporotiques ou à risque d'ostéoporose : données récentes et nouvelles pratiques. Revue du Rhumatisme. 2019. (PDF)](https://www.grio.org/documents/page246/la-supplementation-en-vitamine-d-grio-revrhum2019-2.pdf)
...
- [Briot K, et al. Risque des femmes de même âge ayant fait une fracture. Revue du Rhumatisme. 2012. (PDF)](https://www.grio.org/documents/page500/boite-a-outils-osteoporose500-1401218558.pdf)
...
- [GRIO (site officiel)](https://www.grio.org/)
