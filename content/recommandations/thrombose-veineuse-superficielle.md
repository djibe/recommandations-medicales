...
noindex = true
prefix = "la "
description = "Recommandations pour le diagnostic et la prise en charge de la thrombose veineuse superficielle (TVS). Echodoppler veineux systématique, compression voire anticoagulation"
...
english = ["Superficial venous thrombosis (SVT)"]
sctid = "275517008"
icd10 = ["I82.9"]
image = true
imageSrc = "Trajet de la grande veine saphène, souvent le siège de thrombose veineuse superficielle. Mikael Häggström, CC BY-SA 4.0, via Wikimedia Commons"
todo = "flow, revoir posologies"
+++
...
- L'examen clinique recherche le caractère provoqué ou non de la thrombose (âge, cancer, grossesse -- voir [Clinique](#clinique)), des signes de thrombose veineuse profonde (TVP) associée
...
El l'absence de ces critères, la TVS est dite **non provoquée** et justifie la [recherche d'un cancer](/tags/cancer/), des maladies de Behçet et de Buerger, de pathologie hématologique, auto-immune ou d'une thrombophilie.
...
- Hémorragie active ou risque hémorragique élevé avec TVS symptomatique
  - Calcul du risque hémorragique (ex. {{< modal-btn modal-score-riete >}}score de RIETE{{< /modal-btn >}})
...
- TVS symptomatique unique de +5 cm de longueur située à > 3 cm de la jonction saphéno-fémorale (critères de *Calisto*):
  - ==[Fondaparinux SC](https://www.ema.europa.eu/fr/documents/product-information/arixtra-epar-product-information_fr.pdf) (Arixtra®, gén) 2,5 mg/j pendant 45 jours==
...
- **Insuffisance rénale sévère** ({{< modal-btn modal-score-cockroft >}}Cockroft{{< /modal-btn >}} < 30 mL/min):  
  Surveillance clinico-échographique initiale. Seule la [tinzaparine](https://base-donnees-publique.medicaments.gouv.fr/medicament/62007966/extrait#tab-rcp) à dose **préventive** doit être utilisée pour une clairance de 20 à 30 mL/min.
