...
todo = "PA cible, ARA2 poso, sup. Table 4 MRA+5Sacu+7Diur https://www.santepubliquefrance.fr/determinants-de-sante/nutrition-et-activite-physique/documents/article/indications-d-un-programme-d-activite-physique-en-complement-au-traitement-medical, Beck"
+++
...
En état stable l'examen est pauvre. La présence de signes cliniques est donc un élément de gravité.
...
Sensibilité de 89%: << L'IC est peu probable en cas d'ECG totalement normal >> (*ESC 2021*)

L'épreuve d'effort (EEVO<sub>2</sub>) est systématique en diagnostic d'IC (*SFC 2018*).
...
- Diurétiques de l'anse à visée symptomatique
  ...
  - Augmenter dès prise de 2 kg en 3j
- Activité physique
...
**3 objectif:** réduire la mortalité, les hospitalisations pour décompensation, améliorer les capacités fonctionnelles et la qualité de vie.
...
{{%warning%}}Les AINS, anti-COX2, le sotalol, le diltiazem, le vérapamil et la flécaïne sont contre-indiqués{{%/warning%}}
...
Indication: symptômes invalidants, mauvais pronostic, absence d'alternative thérapeutique et capacités à être traité par immunosuppresseurs.

{{% /collapse %}}
{{%collapse "Traitement de l'IC à FE modérément diminuée" %}}
...
- Consultation 1-2 après la sortie  
...
- Activité physique
- Posologies en cours
- Suivi iono-créat, NFS (min 2/an), ferritinémie (≥ 100 ng/mL)
- Vaccinations
- ECG annuel
...
style suspicion stroke:#4150f5, stroke-width:1px
  suspicion --> clinique("<b>Examen clinique</b><hr>- HTA, coronarien<br>- Cardiotoxiques, diurétiques<br>- Orthopnée ou autre<hr>- Crépitants, œdèmes chevilles<br>- Souffle cardiaque<br>- Turgescence jugulaire<br>- Choc de pointe<hr>- ECG anormal")
    clinique --> BNP("NT-proBNP &ge; 125 pg/mL<br>ou BNP &ge; 35 pg/mL<br>ou forte suspicion d'IC")
