+++
id = "019a5980-6806-724a-9636-d8c2a32eff47"
title = "Plateformes d'entraînement et quiz en dermatologie"
titleSeo = "Entraînement et quiz en dermatologie"
prefix = "les "
description = "Collection de banques d'images et de quiz en dermatologie pour l'évaluation des connaissances."
synonyms = []
...
- La dermatologie représente une part conséquentes des consultations en médecine générale, par les pathologies multiples, avec présentations variées, sur des peaux elles aussi différentes
- Un entraînement sur des banques d'images permet d'améliorer la précision du diagnostic et un traitement adapté
- Les sites suivants permettent de tester ses connaissances en dermatologie sur des séquences d'images. Des plateformes manquantes peuvent être signalées en bas de la page
...
| [dermoscopedia](https://dermoscopedia.org/Main_Page) ||
...
- [Dermagic](https://dermagic.fr) (inscription)
- [Dermatoclic](https://www.dermatoclic.com)
- [DermatoKid](https://dermatologiepediatrique.wordpress.com)
- [Maladies éruptives de l'enfant (PDF)](https://www.urgencehsj.ca/wp-content/uploads/EruptionsPurpuras.pdf)
- [Thérapeutique dermatologique](https://www.therapeutique-dermatologique.org) (inscription)
