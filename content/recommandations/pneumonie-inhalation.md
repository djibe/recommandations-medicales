+++
id = "019a792b-4c17-79bd-9115-7809d2e14327"
title = "Pneumonie d'inhalation"
titleSeo = "Pneumonie d'inhalation"
prefix = "la "
description = "Recommandations pour le diagnostic et la prise en charge de la pneumonie d'inhalation. Bilan par scanner thoracique et antibiothérapie amoxicilline / acide clavulanique"
synonyms = []
...
annees = "2025"
sources = ["SPILF"]
tags = ["dyspnée", "fatigue", "fièvre", "gériatrie", "toux"]
...
Pneumonie chimique
: Tableau respiratoire aigu immédiatement dans les suites d'une fausse route, par aspiration du contenu gastrique sans cause bactérienne.
...
Critères diagnostiques de la pneumonie d'inhalation:

1. Signes cliniques d'infection respiratoire aiguë basse après une période d'incubation
2. Troubles de déglutition ou inhalation
3. Infiltrat(s) radiologique(s) nouveau(x)
...
> [!INFO]
> Différencier d'une pneumonie chimique: tableau respiratoire aigu immédiatement dans les suites d'une fausse route.

Le diagnostic de pneumonie d'inhalation est le plus souvent **présomptif**, les troubles de déglutition manquant souvent lors de l'examen.

### Interrogatoire

- Antécédents: fausses routes, pneumonies, maladie respiratoire, comorbidités, AVC, chirurgie récente
- Traitements en cours
- Allergies médicamenteuses
- Notion du moment de survenue de la fausse route (durée de l'incubation)
...
- Recherche de troubles de la déglutition, troubles de la vigilance, reflux gastrique, réflexes de toux et nausées
- Suivi dentaire
...
### Bilan de la pneumonie d'inhalation

==**Scanner thoracique**== sans injection urgent.
...
> [!INFO]
> << Aucun examen complémentaire microbiologique systématique n'est recommandé. >> -- *SPILF 2025*

{{% /collapse %}}
{{%collapse "Prévention" %}}

Mesures de prévention des pneumonies d'inhalation:

- Recherche de troubles de la déglutition chez les sujets à risque
- Arrêt des traitements à risque  
  IPP, anticholinergiques, antipsychotiques typiques ou atypiques, benzodiazépines ou hypnotiques.
- Post-AVC: utilisation des IEC (origines asiatiques ++)
- Rééducation, orthophonie
- Conseils posturaux:
  - Proclive > 30 % (nutrition entérale ou troubles de la vigilance ++)
  - Gestes spécifiques lors de la déglutition: manœuvre de déglutition menton descendu vers le sternum
  - Verticalisation et rééducation précoce
  - Mobilisation et mise au fauteuil
  - Repas assis

{{% /collapse %}}
{{%collapse "Critères d'hospitalisation" %}}

Critères d'hospitalisation pour une pneumonie d'inhalation:

Évaluation hospitalière urgente si ≥ 1 critère parmi:

- Risque de pyocyanique (pour pipéracilline-tazobactam):
  - Antécédent de colonisation ou d'infection respiratoire récente (< 1 an) à *Pseudomonas aeruginosa*
  - Antibiothérapie parentérale récente (< 3 mois)
  - BPCO sévère
  - Bronchiectasies
  - Trachéotomie
...
{{% /collapse %}}
{{%collapse "Traitement de la pneumonie d'inhalation" %}}

> [!WARNING]
> En cas de signes de gravité, appel du SAMU.
...
- Antibiothérapie urgente:
  ...
  - Si insuffisance rénale sévère (10-30 mL/min): amoxicilline / acide clavulanique 1g en dose de charge puis 500 mg toutes les 8 heures
...
- Test de déglutition
- **Consultation de contrôle systématique à 72 heures**

> [!WARNING]
> Ne pas utiliser pour une pneumonie d'inhalation: corticoïdes, aérosols ou scopolamine.

### Réévaluation à 72 heures

> **NB.** La toux peut persister et n'est donc pas un critère de guérison.

**Critères de guérison** nécessaires à 72 heures:
...
- Si tous les critères de guérison sont présents: terminer le traitement à **J5**
- **Si échec à 72 heures:** **hospitalisation** pour pipéracilline-tazobactam

**NB.** En cas de rechute ou de récidive après une évolution initiale favorable, **reprendre le même traitement** (10 à 30 % dans le mois).

> [!INFO]
> Après une fausse route, surveillance simple 48 à **72 heures** après. En cas de survenue d'une pneumonie d'inhalation, avis spécialisé en cas de colonisation connue à SARM ou au pyocyanique.

{{% /collapse %}}
{{%collapse "Suivi" %}}

La pneumonie d'inhalation doit faire réaliser une évaluation rigoureuse à distance:

- Évaluation de l'autonomie, cognitive
- Évaluation nutritionnelle, {{< modal-btn modal-mna >}}dépister une dénutrition{{< /modal-btn >}}, rechercher une gloutonnerie
...
L'étiologie d'une pneumonie d'inhalation peut être recherchée avec la [checklist de Yoshimatsu](https://onlinelibrary.wiley.com/doi/10.1111/crj.13557).

> << Bien que classiquement proposée, il n'existe aucun élément dans la littérature scientifique étayant le bénéfice de l'eau gazeuse pour stimuler la vigilance. >> -- *SPILF*
