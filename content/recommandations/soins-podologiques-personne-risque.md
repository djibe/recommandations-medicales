...
annees = "2020"
sources = ["HAS"]
tags = ["chute", "dépistage", "diabète", "douleur", "gériatrie", "neuropathie", "prévention", "vertige"]
...
: Ongles plats avec bords relevés << en cuillère >> très fragiles, souvent fissurés ou friables. Fréquent en cas de [carence en fer]({{% relref "anemie-ferriprive.md" %}}) ou d'[hémochromatose]({{% relref "hemochromatose.md" %}}).
