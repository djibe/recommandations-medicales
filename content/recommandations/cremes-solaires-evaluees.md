...
- Les crèmes solaires (ou produits de protection solaire) sont une composante importante de la photoprotection pour la prévention des cancers cutanés
- Ces crèmes solaires doivent être utilisées en complément des messages de prévention des mélanomes:
...
- Une crème d'indice de protection (dit IP, FPS ou SPF) 50 est recommandée, atteignant un SPF d'au moins 50, ou 50+ (atteignant au moins 60), avec nouvelle application toutes les 2 heures et après chaque baignade
...
: Reflète le niveau de protection contre les UVB apporté par un produit de protection solaire.

Rayons ultra-violets B (UVB)
: Les rayons ultra-violets B ne pénètrent que l'épiderme. Ils sont 1 000 fois plus puissants que les rayons UVA et sont les principaux responsables des coups de soleil et de cancers cutanés.

Rayons ultra-violets A (UVA)
: Les rayons ultra-violets A pénètrent profondément dans la peau et sont responsables de son vieillissement.

> [!INFO]
> << Dans un souci de simplification, l'Anses préconise de supprimer des étiquettes le facteur de protection solaire (FPS) - valeur relative à la protection contre les UVB - et le logo UVA. Elle propose de garder uniquement les catégories de protection faible, moyenne ou forte, qui intègrent déjà la protection pour les deux types d'UV. >> -- *Anses*

### Abréviations

FPS
: facteur de protection solaire contre les UVB (ou SPF -- sun protection factor)

IP
: Indice de protection (voir *FPS*)
{.dl-inline}

{{% /collapse %}}
{{%collapse "Crèmes solaires efficaces" "show" %}}

Les **meilleurs produits testés** sont: A-Derma, Bariésun (Uriage) et Bioderma.

> Pour respecter la **réglementation SPF 50+**, la valeur minimale in vitro de l'indice de protection (IP ou SPF) doit être d'**au moins 60**, et 50 pour le SPF 50. Les mesures ci-dessous prouvent que l'affichage des crèmes est souvent mensonger.

Lors des tests in vivo, la dose appliquée doit être de 2 mg/cm².

Le tableau ci-dessous rassemble donc les crèmes disponibles pour protéger au mieux nos patients.
...
- [Direction générale de la concurrence, de la consommation et de la répression des fraudes. Protection solaire : les conseils pour bien choisir son produit](https://www.economie.gouv.fr/dgccrf/les-fiches-pratiques/protection-solaire-les-conseils-pour-bien-choisir-son-produit)
- [Regard sur les cosmétiques. Bilan solaire 2024, la roulette russe ! 24/06/2024.](https://www.regard-sur-les-cosmetiques.fr/nos-regards/bilan-solaire-2024-la-roulette-russe-2962/)
- [Anses. Produits de protection solaire : mieux informer les consommateurs pour une meilleure protection.](https://www.anses.fr/fr/content/produits-de-protection-solaire-mieux-informer-les-consommateurs-pour-une-meilleure-protection)
