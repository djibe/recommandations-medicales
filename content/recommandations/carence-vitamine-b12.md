...
- Carence d'apports
  - [Régimes végétalien]({{< relref "regime-vegetarien-vegetalien.md" >}}) (vegan) et végétarien sans lait
  - Allergie aux œufs, lait ou poisson
  - Régime alimentaire non diversifié
  - Anorexie mentale
- Antécédents familiaux de déficit en vitamine B12 ou de maladie auto-immune
- Comorbidités
  - Maladie de Biermer (gastrite auto-immune) ou autre gastrite atrophique
  - Maladie cœliaque, dysthyroïdie auto-immune (Hashimoto, Basedow), diabète type 1
- Médicament à risque  
...
- Chirurgie gastro-intestinale  
  Chirurgie bariatrique, gastrectomie (cancer de l'estomac) ou résection de l'iléon terminal.
- Toxique: protoxyde d'azote
...
Gastro-entérologue en cas de suspicion de gastrite autoimmune ou de signes digestifs (dyspepsie, nausées).

{{% /collapse %}}
{{%collapse "Traitement" %}}

supplémenter systématiquement:

- Carence avérée  
- Régime végétarien ou vegan (*Anses 2025*)
- Intramusculaire: Biermer, gastrectomie ou résection iléale complète

considérer en IM si: malabsorption, symptômes sévères (anémie, ataxie), difficultés d'observance ou échec par voie orale

Considérer la supplémentation:

- Dosage diagnostique indéterminé avec: grossesse, allaitement, symptômes sévères (anémie, ataxie) ou risque élevé de carence (gastrite autoimmune, chirurgie bariatrique ou gastrectomie)

Amélioration des symptômes sous 2 semaines (mais peut être retardée jusqu'à 3 mois). Résolution peut être tès longue.
Aggravation temporaire possible.

Réévaluation en consultation dans les 3 mois (1 mois si grossesse/allaitement): signes et symptômes, doses réellement prises.
Si aggravation ou nouveau symptômes sous traitement: considérer un dosage de l'homocystéine ou de la MMA si non fait, réévaluer un diagnostic différentiel, augmenter les doses.

Poursuivre la supplémentation sauf si la cause est résolue (ex. carence d'apports).

### Doses

grossesse ou allaitement: ≥ 1 mg/j
...
Uniquement à base de: cyanocobalamine, méthylcyanocobalamine ou adénosylcobalamine.
...
graph TB
  risque["Situation à risque<br>de carence en B12<br>—<br>TODO:"] --> dosage("Dosage de la<br>vitamine B12")
  symptômes["Signes ou symptômes<br>de carence en B12"] --> dosage
    dosage -- "&lt; 180 ng/mL<br>(133 pmol/L)" --> diagnostic["Carence en<br>vitamine B12"] -- FDR --> essai("- Correction FDR<br>- Supplémentation") -. Échec .-> gastro("Facteur intrinsèque<br>et avis gastro")
      diagnostic -- "0 FDR" --> gastro
    dosage -- "180-350" --> indetermine
