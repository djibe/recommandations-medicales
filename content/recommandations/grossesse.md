...
<form class="d-flex align-items-center my-4">
  ...
  <button class="btn btn-primary btn-lg btn-shaped ml-3" onClick="window.open(`http://le-crat.fr/articleSearchSaisie.php?recherche=${document.getElementById('grossesse-crat').value}`); return false;">
