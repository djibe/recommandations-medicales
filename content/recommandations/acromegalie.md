...
todo = "rankok | validation faite Thierry BRUE"
flowchart = true
+++
...
- {{< modal-btn modal-rcv >}}Risque cardiovasculaire{{< /modal-btn >}} (calcul du [SCORE2]({{% relref "score2.md" %}}) en prévention primaire)
