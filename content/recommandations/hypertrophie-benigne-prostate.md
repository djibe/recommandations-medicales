...
sources = ["EAU"]
tags = []
anglais = ["Benign prostatic hyperplasia"]
sctid = "266569009"
draft = true
image = false
imageSrc = ""
...
Après 60 ans, 1 seule miction nocturne et un intervalle de 4 heures entre 2 mictions est considéré comme normal
{{%/info%}}
...
- Qualité de vie  
  ...
  - Score IPSS systématique
- Dysfonction érectile avec score IIEF
- Agenda mictionnel en nycturie ou gêne de remplissage
...
Bilan recommandé en 1<sup>re</sup> intention (*EAU 2017*):

- BU ou ECBU  
{{%class%}}Seul examen complémentaire recommandé de façon systématique.{{%/class%}}
...
Indication: symptômes légers ou acceptables (score IPSS ≤ 7-8) avec gêne minime.
...
Contre-indications: allergie alfuzosine, hypotension orthostatique, insuffisance hépatique, IRC sévère, association CYP3A4.  
...
Indication: symptômes modérés à sévères.  
Peut être associé aux inhibiteurs de la 5α-réductase chez les hommes avec gêne modérée à sévère et prostate > 40 mL.  
...
Indication: gêne modérée à sévère ou avec dysfonction érectile.

Tadalafil (Cialis®, non remboursé).  
Effets indésirables: hypotension artérielle et collapsus.

### Chirurgie

Indications: HBP compliquée, SBAU modérés ou sévères résistants au traitement médical, préférence du patient.
