...
3. Femme +75 ans, d'autant plus si hypertendue ou fumeuse (peut être considéré)
4. +50 ans avec antécédent familial d'AAA au 1^er^ degré (parents/fratrie; recommandé)
5. En cas d'[artériopathie des membres inférieurs]({{% relref "arteriopathie-obliterante-membres-inferieurs.md" %}}) ou d'autre localisation d'athérome périphérique

Il peut être répété périodiquement si le bilan est normal et que le sujet est relativement jeune.

Compléter l'imagerie par **angioscanner ou angio-IRM** en cas d'images anormales.
...
### Échodoppler aortique

L'échodoppler de l'aorte est l'examen de référence pour le dépistage et la surveillance de l'anévrysme de l'aorte.
...
- [Correction d'une hypertension artérielle]({{% relref "hypertension-arterielle.md" %}})  
  Cible < 120/80 mmHg. Privilégier bêtabloquant et ARA2.
- Considérer une statine modérée ou forte (sauf faible risque cardiovasculaire)
- Si athérome, considérer de l'aspirine faible dose (et pourrait être utilisée raisonnablement dans tous les cas)
- Éviter si possible les fluoroquinolones
- Correction d'un surpoids ou obésité
- Exercice physique régulier
- Dépistage annuel ou contrôle d'un diabète
- Surveillance rapprochée (voir suivi)
- Dépistage de l'entourage de plus de 65 ans  
  Considérer un dépistage avant 65 ans.

### Chirurgie vasculaire de l'anévrysme de l'aorte abdominale

**Indications** à la chirurgie vasculaire: anévrysme de **diamètre ≥ 55 mm** (50 mm chez la femme).

La chirurgie peut être considérée en cas de **croissance rapide** (≥ 10 mm/an ou 5 mm/semestre), d'anévrysme sacculaire ≥ 45 mm.
...
L'anévrysme de l'aorte abdominale (AAA) nécessite une surveillance spécialisée régulière par l'**angiologue** ou le **cardiologue**:

- Aussi souvent que nécessaire par le spécialiste
- Homme: **échodoppler aortique** selon la taille de l'anévrysme:
  - 30-39 mm: tous les 3 ans
  - 40-49 mm: annuel
  - 50-55 mm: tous les 6 mois
  - Diamètre aortique 25-29 mm et espérance de vie de +2 ans: tous les 4 ans
- Femme: **échodoppler aortique** selon la taille de l'anévrysme:
  - 30-39 mm: tous les 3 ans
  - 40-44 mm: annuel
  - 45-50 mm: tous les 6 mois
  - Diamètre aortique 25-29 mm et espérance de vie de +2 ans: tous les 4 ans
