...
description = "Recommandations pour le diagnostic et la prise en charge de l'hypertension artérielle (HTA). Cibles tensionnelles, traitement antihypertenseur IEC, inhibiteur calcique"
longHtml = true
synonyms = ["Hypertension et pression artérielle élevée"]
...
rank = "false"
writing = "todo"
todo = "hypertensive emergencies, normes enfants [925,930,931], SEO 'reco hta', A LIRE: Bernatos plus de 80 ans dépendants polypatho (ehpad) : 149, https://afpa.org/outil/normes-cardiorespiratoires-utiles/"
flowchart = true
+++

{{%article-summary%}}

- L'hypertension artérielle est la maladie chronique la plus fréquente, définie une pression artérielle systolique (PAS) ≥ 140 mmHg et/ou diastolique ≥ 90 mmHg au cabinet (135/85 mmHg en automesure et 130/80 mmHg en MAPA) à partir de 18 ans
- Dépister l'hypertension artérielle dès 3 ans, au moins tous les 3 ans avant 40 ans, puis annuellement (1/3 des adultes sont hypertendus et les 3/4 ne sont pas contrôlés)
...
- Confirmer le diagnostic par des automesures ou MAPA répétées
- Rechercher des complications et calculer le {{%modal-btn "modal-rcv"%}}risque cardiovasculaire{{%/modal-btn%}} ([SCORE2]({{% relref "score2.md" %}}) en prévention primaire) pour déterminer le seuil de traitement et la cible de LDL cholestérol
...
: NB. L'ESC parle désormais d'hypertension et de pression artérielle élevée.
: Maladie chronique la plus fréquente définie une pression artérielle systolique (PAS) ≥ **140 mmHg** et/ou diastolique ≥ **90 mmHg** au cabinet (135/85 mmHg en automesure et 130/80 mmHg en MAPA, *ESH 2024*) à partir de 18 ans. Avant 16 ans: pression artérielle ≥ 95^e^ percentile. De 16 à 18 ans: ≥ 130/85 mmHg (*[ESC 2022](https://academic.oup.com/eurheartj/article/43/35/3290/6633855)*).
: Le seuil de traitement est 14/9, sauf risque cardiovasculaire marqué ou espérance de vie limitée. Chez le **sujet fragile**, les seuils sont individualisés.
...
: Pressions mesurées au cabinet ≥ 140/90 mmHg, confirmées par automesure tensionnelle malgré un traitement optimal et bien suivi avec RHD et au moins 3 traitements à doses maximales tolérées, dont un diurétique apparenté aux thiazidiques, un inhibiteur du SRAA et un inhibiteur calcique. Elle concerne 10 % des hypertendus.
...
### Catégories de l'hypertension artérielle au cabinet
...
| **PA élevée** <br> (anc. Normale / Normale haute ESH 2023) | **120-139** | et/ou | **70-89** | Évaluation du RCV, **RHD systématiques**, dépistage annuel. <br> **Médicaments si:** SCORE2 (-Diabetes) ≥ 10 %, maladie cardiovasculaire ou SCORE2 5-9 % avec autres risques **et** PA confirmée ≥ 130/80 après 3 mois de RHD. Peut être discuté pour les fiables risques. |
| **Hypertension artérielle** <br> (anc. Grades 1, 2 et 3 ESH 2023) | **≥ 140** | et/ou | **≥ 90** | **Confirmation:** [AMT]({{% relref "automesure-tensionnelle.md" %}})/MAPA ou ≥ 1 mesure au cabinet. <br> **Traitement:** antihypertenseur (considérer si +85 ans, fragilité ...), RHD, dépistage des complications. **Cible:** 120-129 / 70-79 mmHg. |
...
{caption="Grades d'hypertension artérielle selon les mesures de pression artérielle au cabinet à partir de 18 ans. Drs JB Fron et S Baudrand d'après *ESC 2024*, *ESH 2023*" class="table-wrap"}
...
3. Hypertension blouse blanche (15-25 %)  
  Hypertension au cabinet et absente au domicile. RHD et dépistage annuel.
...
> [!INFO]
> En cas d'hypertension avant 40 ans, commencer par éliminer un syndrome d'apnées du sommeil.
...
- Mesures
  - Utiliser le bras avec les valeurs les plus hautes  
    Une différence > 10 mmHg nécessite un avis cardiologique (asymétrie tensionnelle).
  ...
  - Diagnostic si ≥ 140/90 mmHg (traiter également si 130/80 mmHg avec risque cardiovasculaire élevé)
- Dossier médical
...
> -- *ESC 2024*, *ESH 2024* ([poster (PDF)](https://www.stridebp.org/wp-content/uploads/Office_BP_measurements_Poster.pdf))
...
> [!INFO]
> Noter dans le dossier les valeurs pré-traitement de la pression artérielle.

### Interrogatoire

- Facteurs de risque d'hypertension
  - Antécédents personnels et familiaux  
    Diabète, HTA, maladie cardiovasculaire, AIT/AVC, maladie rénale, [goutte]({{% relref "goutte.md" %}}), complications gravidiques ([pré-éclampsie]({{% relref "pre-eclampsie.md" %}}), diabète gestationnel, accouchement prématuré ...), [ménopause précoce]({{% relref "insuffisance-ovarienne-prematuree.md" %}}), [cancer](/tags/cancer/).
  - Apnées du sommeil
  - Migraine avec aura, maladie inflammatoire, VIH
- Date du diagnostic de l'hypertension, valeurs au diagnostic, aggravation rapide
- Traitements en cours  
  Contraception œstroprogestative, décongestionnants nasaux, AINS, corticoïdes, cyclosporine, venlafaxine, clozapine, carbamazépine, lithium.
- Traitements essayés, observance
- Alcool, tabagisme, drogues
- Réglisse, alimentation, sel
- Niveau d'activité physique, sédentarité
- Homme: [dysfonction érectile]({{% relref "dysfonction-erectile.md" %}})  
...
- Autres bilans possibles:
  - Anomalie ECG, signes ou symptômes de cardiopathie: échocardiographie (ETT)
  - Risque cardiovasculaire modéré avec facteurs surajoutés (hérédité, maladie inflammatoire ...): avis spécialisé
  - Atteinte rénale ou suspicion d'HTA secondaire: échodoppler des artères rénales
  - {{< modal-btn modal-depistage-prevalent >}}Recherche d'AOMI{{< /modal-btn >}}
  - Fond d'œil
  - Déclin cognitif, antécédent familial d'hémorragie cérébrale à l'âge moyen ou de démence précoce: IRM cérébrale

{{% /collapse %}}
{{%collapse "Objectifs tensionnels" "show" %}}

> [!INFO]
> Une diastolique entre 70 et 79 mmHg est la cible pour tout hypertendu. On peut considérer d'abaisser la systolique < 120 mmHg pour obtenir cette valeur de diastolique. La pression cible doit être atteinte sous 3 mois.
> La réduction du risque cardiovasculaire est optimale à 120/70 mmHg.

| Population | Objectif (mmHg) | Source |
| --- | ---: | --- |
| Générale | **120**-129 / **70**-79 | ESC 2024 |
| Pression artérielle élevée<br>avec indication au traitement | idem générale | ESC 2024 |
| Fragilité, +85 ans, EV limitée | Assouplissement<br> possible (ex. < 140) | ESC 2024 |
| HTA systolique/diastolique | idem générale | ESC 2024 |
| HTA résistante | idem générale | ESC 2024 |
| Maladie cardiovasculaire* | idem générale | ESC 2024 |
| [Diabète]({{% relref "diabete-type-2.md" %}}) | idem générale | ESC 2024 |
| [Insuffisance rénale]({{% relref "insuffisance-renale-chronique.md" %}}) | 120-129 / < 80<br>< 120/90 | ESC 2024 |
| Greffe rénale | < 130/80 | ESH 2023, KDIGO 2021 |
| Grossesse | < 140 / 80-90 | ESC 2024 |
{caption="Synthèse des cibles de pression artérielle au cabinet selon le profil de l'adulte hypertendu de plus de 18 ans. Drs JB Fron et S Baudrand d'après les dernières recommandations en vigueur"}

> *Maladie cardiovasculaire = [AIT/AVC]({{% relref "accident-vasculaire-cerebral.md" %}}), [AOMI]({{% relref "arteriopathie-obliterante-membres-inferieurs.md" %}}), [coronaropathie]({{% relref "syndrome-coronarien-chronique.md" %}}), [fibrillation atriale]({{% relref "fibrillation-atriale.md" %}}), [insuffisance cardiaque]({{% relref "insuffisance-cardiaque-chronique.md" %}}), valvulopathie
...
- **Mesures diététiques**:
  ...
  - Décourager la consommation de jus et sodas
- Correction d'un surpoids/[obésité]({{% relref "obesite-adulte.md" %}}) et d'adiposité  
  Tour de taille cible < 94 cm (homme) et 80 cm (femme).
- **Activité physique** quotidienne:
  - Au moins 2h30 à {{< modal-btn modal-met >}}intensité modérée{{< /modal-btn >}} (≥ 30 minutes x 5-7/semaine) ou 1h15 intense (sur 3 jours)
...
{{% /collapse %}}
{{%collapse "Traitement médicamenteux de l'hypertension artérielle" %}}

> [!INFO]
> En cas de population à risque, **considérer** le traitement à partir 140/90 mmHg en cas d'hypotension orthostatique pré-thérapeutique, +85 ans, fragilité modérée/sévère, espérance de vie limitée (< 3 ans).

La prise en charge médicamenteuse de l'hypertension est toujours associée aux [mesures hygiéno-diétetiques](#mesures-hygiéno-diétetiques), l'automesure tensionnelle et la surveillance de l'observance.

- Privilégier une ==**bithérapie d'emblée**== avec un seul comprimé à faible dose
- Escalade thérapeutique mensuelle jusqu'au contrôle optimal (de préférence sous 3 mois)
- Prise au moment choisi à heure fixe
- Le plus souvent à vie
- Suivi au moins **mensuel** jusqu'à l'obtention de la cible puis contrôle à 3-6 mois la première année
- Suivi au long cours **au moins annuel** avec réévaluation des FRCV (si tension équilibrée)
...
La prise en charge initiale de l'hypertension artérielle est une ==**bithérapie faible dose**==, au choix parmi (*ESC 2024 Figure 18*):
...
En l'absence de contrôle à **1 mois** (1 à 3 mois): substituer par une **trithérapie faible dose** {{< modal-btn modal-triple >}}IEC/ARA2 + TZD + ICa{{< /modal-btn >}} en 1 seul comprimé (Triplixam® seul remboursé). Ou associer <button class="chip chip-action" type="button" data-toggle="modal" data-target="#modal-iec">IEC + ICa</button>/<button class="chip chip-action" type="button" data-toggle="modal" data-target="#modal-ara2">ARA2 + ICa</button> et hydrochlorothiazide (HCT).
...
**Hypertension résistante** (non contrôlée par une trithérapie comprenant un IEC/ARA2, un ICa dihydropyridine et un diurétique apparenté aux thiazidiques): avis spécialisé, mesures hygiéno-diététiques rappelées, considérer l'ajout de **spironolactone**.
...
- Côté patient
  - Prise du traitement à heure fixe
...
- **Valeurs de référence:**
  - Seuil diagnostique identique  
    PAS ≥ 140 mmHg et/ou PAD ≥ 90 mmHg avec brassard manuel ou appareil validé, à 2 occasions (ou sur ≥ 15 minutes si sévère). Intérêt de l'automesure tensionnelle.
  - Traiter si ≥ 140/90 mmHg
  - Tension cible < 140/80-90 mmHg  
    Ne pas descendre la diastolique sous 80 mmHg.
- Confirmation par AMT/MAPA  
  [Tensiomètres pour la grossesse]({{% relref "tensiometres-electroniques-valides.md" %}}).
- Classification différente
  - HTA modérée: 140-159/90-109 mmHg
  - HTA sévère: PAS ≥ **160 mmHg** et/ ou PAD ≥ **110 mmHg**, hospitalisation en urgence
- Définitions
...
- Activité physique de faible/moyenne intensité adaptée
- Bilan mensuel  
...
{{< mermaid title="Prise en charge de l'hypertension artérielle de l'adulte. Dr JB Fron d'après ESC 2024" >}}
graph TB
  dépistage["<b>Dépistage de l'HTA chez le +18 ans</b><br>ou symptômes<br>—<br>- Avant 40 ans et PA &lt; 120/70 : min. tous les 3 ans<br>- Autres cas : min. annuel<br>—<br>Mesures et appareil standardisés"] -- "PAS ≥ 120<br>et/ou PAD ≥ 70<br>avec risque cardiovasculaire<br>non faible" --> confirmation("<b>Confirmation</b><br>—<br>- Automesure 7 jours<br>(PA élevée: 120-134 / 70-84,<br>HTA: ≥ 135/85)<br>- ou MAPA<br>- ou ≥ 1 consultation")
    confirmation -- "AMT ≥ 135<br>et/ou 85" --> diagnostic
    diagnostic("<b>Diagnostic</b><br>—<br>- Traitement (plus bas)<br>- Risque cardiovasculaire<br>- Dépistage des complications: ECG...<br>(min. /3 ans)")
      diagnostic -- et --> traitement("<b>Traitement</b><br>—<br>- Régime hygiéno-diététique:<br>tabac, sel, méditerranéen,<br>surpoids, activité physique<br>- Bithérapie 2 en 1 faible dose<br>et titration mensuelle, <br>ttt à vie<br>- Cible &lt; 12./7. mmHg<br>- Automesure<br>- Suivi ≥ 1/an") -. Comorbidités .-> cardiologue("<b>Cardiologue</b><br>—<br>- Maladie cardiovasculaire<br>- Susp HTA secondaire:<br>avant 40 ans,<br>apparition/aggrav. rapide,<br>résistante ou sévère<br>complications multiples,<br>hypokaliémies, Cushing")
  confirmation -- "PA augmentée<br>Sauf +85 ans,<br>fragilité ..." --> MCV("Maladie CV (SCA, AIT/AVC, MRC, IC, FA, valvulopathie...), diabète +60 ans, complication HTA, hyperchol. fam.") -- Oui --> diagnostic
    MCV -- Non --> SCORE2("SCORE2 <br>(-Diabetes)") -- "≥ 10 %:<br>RHD 3 mois" --> diagnostic
      SCORE2 -- "5-9 %" --> modéré("Autres FRCV ?<br>—<br>Asie Sud-Est, hérédité, contexte socio-éco, auto-immunité, tble psy, VIH, complications gravidiques") -- "Oui:<br>- Cardiologue pour<br>restratification<br>- RHD 3 mois" --> diagnostic
        modéré -- Non --> faible
      SCORE2 -- "&lt; 5 %" --> faible("- RHD<br>- Dépistage annuel")
