...
: 500.000 cas/an. Gravité potentielle même sans comorbidités, 1re cause de décès par infection.
...
- Antécédents  
  Grossesse, comorbidités ([splénectomie]({{< relref "asplenie.md" >}}) ++).
...
Une auscultation normale n'élimine pas le diagnostic
{.alert .alert-warning}
...
### Tableau de pneumonie atypique à germe intracellulaire
...
- Population à risque: comorbidités, âge avancé, immunodépression, tabagisme
...
- En ambulatoire, PCR nasopharyngée en cas de suspicion de pneumopathie atypique bien tolérée: *Mycoplasma pneumoniae*, *Chlamydophila pneumoniae* + sérologie *M. pneumoniae*
...
{{% /collapse %}}
{{%collapse "Critères d'hospitalisation pour pneumopathie" %}}
...
- Signes de gravité
  ...
  - PAS < 90 mmHg, FC > 120/min, température < 36 ou > 40°C
  - {{< clinique/detresse-respiratoire >}}
  - {{< clinique/hypoxemie >}}
  - {{< clinique/hypercapnie >}}
- Terrain à risque
  - Immunodépression (urgence ++)  
    Corticothérapie générale, immunosuppresseurs, [splénectomie]({{< relref "asplenie.md" >}}), [VIH]({{< relref "vih-sida.md" >}}), cachexie ...
  - Comorbidité à risque de décompensation  
    Insuffisance cardiaque ou rénale, AVC, hépatopathie chronique, diabète déséquilibré, drépanocytose, cancer évolutif
  - Hospitalisation dans l'année
  - Vie en institution, isolement, défaut d'observance
- Extension radiologique TODO:
- Tableau atypique ou incertain
- Dégradation à 48-72 heures
...
- Sevrage tabagique
- [Indications à la vaccination antigrippale]({{< relref "grippe.md" >}}) (+65 ans, grossesse, diabète ...)
  - Indications à la vaccination pneumococcique
  - [Asplénie]({{< relref "asplenie.md" >}})
  - [Asthme en ALD]({{< relref "asthme.md" >}})
  - [BPCO]({{< relref "bronchopneumopathie-chronique-obstructive.md" >}})
  - [Diabète type 1]({{< relref "diabete-type-1.md" >}}) ou [2]({{< relref "diabete-type-2.md" >}})
  - [Hépatite B active]({{< relref "hepatite-b.md" >}})
  - [Hypertension artérielle pulmonaire]({{< relref "hypertension-arterielle-pulmonaire.md" >}})
  ...
  - [Nourrisson]({{< relref "examens-suivi-nourrisson.md" >}}) (rattrapage jusqu'à 23 mois)
...
Selon l'orientation du tableau clinique:

- Amoxicilline  
  ou macrolide (azithromycine, spiramycine, clarithromycine)
- Alternative: pristinamycine (double sensibilité pneumocoque + intracellulaires)
...
#### PAC avec comorbidités, alcool ou sujet âgé ambulatoire

- Amoxicilline - acide clavulanique ou ceftriaxone IM (voire FQAP lévofloxacine)
...
- Amoxicilline - acide clavulanique
- Alternative: C3G ceftriaxone + métronidazole

#### Pneumonie d'inhalation

Hospitalisation conseillée (*CMIT*)
