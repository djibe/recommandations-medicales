...
- Situations ou symptômes évocateurs
  ...
  - Troubles des menstruations ([aménorrhée]({{% relref "amenorrhee.md" %}})), [infertilité]({{% relref "infertilite-couple.md" %}}), [SOPK]({{% relref "syndrome-ovaires-polykystiques-sopk.md" %}})/SMOP
  - Symptômes digestifs inexpliqués
  - Vomissements répétés ou [hypokaliémie]({{% relref "hypokaliemie.md" %}}) inexpliqués
