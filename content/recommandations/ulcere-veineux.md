...
- Symptômes
  ...
  - Œdèmes vespéraux
  - Crampes au repos
- Dépister une [dénutrition]({{< relref "denutrition.md" >}}) (score {{< modal-btn modal-mna >}}MNA{{< /modal-btn >}})
...
Mesure systématique de l'IPS devant un ulcère de jambe (*HAS 2006*).

L'ulcère est dit << veineux pur >> pour un IPS de 0,9 à 1,3 et << mixte à prédominance veineuse >> de 0,7 à 1,9.

### Échodoppler veineux

Réalisation systématique d'un écho-doppler veineux devant un ulcère de jambe (*HAS 2006*).
...
[Annuaire des centres de cicatrisation](https://www.google.fr/maps/d/viewer?mid=1FmUFLwFbjajLfDN5qxxbhc1Qb7Qs2Ap_&ll=46.50134968450305%2C4.2535053308609605&z=7)
...
- Déclarer une [ALD 31]({{< relref "affection-longue-duree.md" >}}) en cas d'ulcères récidivants

> En cas de varices, compression veineuse > 20 mmHg (classe 2+).
...
La compression veineuse est dite à haut niveau au-delà de 30 mmHg à la cheville. Les bandes doivent être posées par un professionnel entraîné.
...
- [omedit Normandie. Guide d'aide pour la prescription de pansements.](https://www.omedit-normandie.fr/boite-a-outils/dispositifs-medicaux/pansements/pansements,5364,12407.html)
