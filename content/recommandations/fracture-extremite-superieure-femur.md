...
sctid = "263225007"
icd10 = ["S72.0", "S72.1", "S72.2", "S72.7", "S72.9"]
image = true
...
todo = "flow | échelle géria mini-GDS"
+++

{{%article-summary%}}

- Les fractures de l'extrémité supérieure du fémur (FESF) sont un groupe de {{< modal-btn modal-fracture-severe >}}fractures sévères{{< /modal-btn >}} du fémur atteignant le col anatomique (fracture cervicale) ou le(s) trochanter(s) (fracture trochantérienne)
...
- +65 ans: Troubles cognitifs et autres fragilités, {{< modal-btn modal-mna >}}dénutrition{{< /modal-btn >}}
- Évaluation de l'autonomie
- Histoire de la maladie  
  Le plus souvent par chute de sa hauteur (dite de faible énergie) déterminant une << {{< modal-btn modal-fracture-severe >}}fracture sévère de fragilité{{< /modal-btn >}} >>.
- Temps resté au sol
...
{{% /collapse %}}
{{%collapse "Prévention des fractures du col du fémur et trochanters" %}}
...
{{% /collapse %}}
{{%collapse "Suivi après fracture du col du fémur" %}}
...
- Ostéoporose
  - Ostéodensitométrie systématique  
    Traitement par biphosphonate **[zolédronate 5 mg IVL]({{% relref "perfusions-domicile-perfadom.md" %}})** annuel si T-score ≤ -1 (voir [ostéoporose]({{% relref "osteoporose.md" %}})), avis rhumatologique si T-score compris de 0 à -1 (*GRIO*).
...
- [Gorder A, et al; SFAR, SFTH, SFMV. Prévention de la maladie thromboembolique veineuse péri-opératoire. 2024.](https://sfar.org/prevention-de-la-maladie-thromboembolique-veineuse-peri-operatoire/)
...
- [Drees. Quel risque de décès un an après une fracture du col du fémur ?. Études et résultats. 2016.](https://drees.solidarites-sante.gouv.fr/publications/etudes-et-resultats/quel-risque-de-deces-un-apres-une-fracture-du-col-du-femur)
