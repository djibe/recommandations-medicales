...
Les résultats aux ECNi 2023 publiés par le CNG étant disponibles uniquement en PDF (voir [Sources](#sources)), **RecoMédicales** propose de consulter le classement au concours de l'internat sous forme de tableau dynamique.
...
window.addEventListener('load', () => {
  $(function () {
    $('#ecni-ranks').DataTable({
      ajax: {
        url: 'https://raw.githubusercontent.com/djibe/recommandations-medicales/refs/heads/master/static/data/ecni-2023.json',
        type: "GET",
        dataType: "json",
      },
      columns: [
